...
const youtube = new YouTube("AIzaSyDwXsDwF81xorrV22prGTYXvIRajklKwGg"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyDwXsDwF81xorrV22prGTYXvIRajklKwGg"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on('ready', () => {
    client.user.setActivity(`!help| !link | !site | !Support `,{ type: 'playing' });
})
...
client.on("message", pixelbot => {
  // itzZa1D - Codes Team.
  if (pixelbot.content.startsWith(prefix + "معلوماتي")) {
    // itzZa1D - Codes Team.
...
client.on("message", message => {
  if (message.content === prefix + "بوت") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@665447982778417173>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
...
client.on("message", async Epic => {
  if (Epic.content.startsWith(prefix + "فويس اونلاين")) {
  ...
  if (message.content === prefix + "help") {
    if (message.author.id == message.guild.ownerID) {
      message.author
        .send(
          `   
**__الاوامر العامه__** ⭐️
**\`${prefix}بوت\` : لعرض معلومات عن البوت** 
...
**\`${prefix}دعوات\` : عدد الدعوات للسيرفر**
**\`${prefix}credits\` : لمعرفة رصيدكك ** 
**\`${prefix}link\`الدعوة البوت 
**\`${prefix}سيرفر\`العرض معلومات السيرفر
**\`${prefix}اعلى دعوات\`  :العرض اعلى دعوات شخص في سيرفر 
**\`${prefix}اثبت نفسك\`يطلع الك صور اثبت نفسك
**\`${prefix}الطقس \`الطقس (اسم بلدك)
●▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬●
**__اوامر العاب__** 🎮
**\`${prefix}cuttweet\` : كت تويت
**\`${prefix}هل تعلم\`لعبة بسيطة و مفيدة
**\`${prefix}صراحة\`لعبة صراحة 
●▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬●
**__اشياء اخرى✦__**
**\`${prefix}Support\`:   سيرفر دعم الفني البوت SVQ
**\`${prefix}!site\`موقع البوت
**\`${prefix}link\`الدعوة البوت 
●▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬●
**__الاوامر الإداريــه__** 🛠
**\`${prefix}امسح\` : لمسح الشات** 
**\`${prefix}باند\` : لتبنيد شخص** 
**\`${prefix}فك all\`لفك باند عن شخص او عن الكل
**\`${prefix}طرد\`: لاعطاء كيك لشخص** 
**\`${prefix}افتح\` : لفتح الشات** 
**\`${prefix}قفل\` : لقفل الشات** 
**\`${prefix}اسكت\` : لاعطاء ميوت لشخص** 
**\`${prefix}تكلم\` : لفك ميوت عن شخص** 
...
**\`${prefix}لوق\` :  تحديد روم اللوق**
**\`${prefix}خروج\` : تحديد روم المغادرة**
**\`${prefix}دخول <channel name>\` : لتحديد روم الولكم **
...
**\`${prefix}بوتات \` : لإظهار جميع بوتات السيرفر**
**\`${prefix}رول \` : لاعطاء شخص رتبة**
**\`${prefix} allرول \` : لاعطاء االجميع رتبة معينة**
**\`${prefix}فويس اونلاين \`: لتشغيل فويس اونلاين
**\`${prefix}setCount\`لعمل روم يعطيك عدد لاعضاء
●▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬●
...
●▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬●
  ...
  `
        ...
        .then(() => {
          message.author.send(`**
** ملاحظة : \`البوت لايدعم زيادة الكريدت عن طريق التفاعل ، انما فقط من امر راتبي${prefix} كل 6 ساعات \`**
...
**\`${prefix}رول all\` : لاعطاء االجميع رتبة معينة**       setCount
**\`${prefix}فويس اونلاين \`: لتشغيل فويس اونلاين
**\`${prefix}setCount\`لعمل روم يعطيك عدد لاعضاء
●▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬●
\`\`اوامر التقديم\`\`
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "لوق")) {
    if (!message.channel.guild)
      return message.reply("**This Command Only For Servers**");
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "الغاء الوق")) {
    if (!message.channel.guild)
      return message.reply("**This Command Only For Servers**");
    if (!message.member.hasPermission("MANAGE_GUILD"))
      return message.channel.send(
...
client.on("message", message => {
  if (!message.channel.guild) return;
  if (message.content.startsWith(prefix + "سرعة البوت")) {
    if (message.author.bot) return;
...
type these numbers to confirm: `
  ...
  if (args[0].toLowerCase() === `${prefix}راتبي`) {
    let cooldown = 8.64e7;
...
client.on("message", async message => {
  ...
  let room = message.content.split(" ").slice(1);
  let findroom = message.guild.channels.find(r => r.name == room);
  if (message.content.startsWith(prefix + "دخول")) {
...
//سيرفر دعم الفني https://discord.gg/NGC2yJP البوت SVQ


client.on('message', message => {
  if (true) {
if (message.content === '!link') {
      message.author.send(' 𝑆𝑉𝑄 𝐵𝑂𝑇: https://discord.com/api/oauth2/authorize?client_id=712697181995532391&permissions=8&scope=bot').catch(e => console.log(e.stack));
 //SV-Q_LS
    }//SV-Q_LS
   }//SV-Q_LS
  });client.on('message', message => {
  ...
  .setColor("#9B59B6")
  .addField(" Done | تــــم" , " |تم رسال رابط خاص")
     //SV-Q_LS
     //SV-Q_LS
//SV-Q_LS
  message.channel.sendEmbed(embed);
...
let prefix = "!";
let args = message.content.split(' ');
  if(args[0].toLowerCase() === (prefix + "سيرفر")) {
        let embed = new Discord.RichEmbed()
        .addField(`:id: Server ID:`, `${message.guild.id}`, true)
...
client.on('message',async message => {//Ve , 𝐀𝐤𝟑𝐛𝟎𝟎𝐝#1379
  if(message.content.startsWith(prefix + "روم وقتي")) {//Ve , 𝐀𝐤𝟑𝐛𝟎𝟎𝐝#1379 if(!message.guild.member(message.author).hasPermission('MANAGE_CHANNELS')) return message.reply('? **ليس لديك الصلاحيات الكافية**');
  ...
  message.guild.createChannel("?? - Time  00", 'voice').then((c) => {
    ...
    c.overwritePermissions(message.guild.id, {
      ...
      minutes = currentTime.getMinutes(),
      seconds = currentTime.getSeconds(),
      years = currentTime.getFullYear(),//Ve , 𝐀𝐤𝟑𝐛𝟎𝟎𝐝#1379 
      month = currentTime.getMonth(),//Ve , 𝐀𝐤𝟑𝐛𝟎𝟎𝐝#1379 
      day = currentTime.getDate(),//Ve , H𝐀𝐤𝟑𝐛𝟎𝟎𝐝#1379 
...
client.on('message',message =>{
    if(message.content.startsWith(prefix + 'اعلى دعوات')) {
...
client.on("message", async msg => {
  if (msg.content.startsWith(prefix + "اثبت نفسك")) {
    const Canvas = require("canvas");
    let mentions = msg.mentions.members.first();
    if (!mentions) {
...
client.on("message", message => {
  if (message.content === "!site") {
    let invitelink = `https://sokemanjan1.wixsite.com/svqbot`;
    const embed = new Discord.RichEmbed().setColor("#36393e").setDescription(`
 **Link site SVQ  ​موقع البوت** \`\`↓↓\`\`
**  [Click here to enter the site SVQ link](${invitelink})**
`);
    message.channel.sendEmbed(embed);
  }
});
...
if (message.content.startsWith(prefix + "الطقس")) {
    if (!loc) return message.reply("Usage: `الطقس! <capita|countryl>`");
...
if (message.content === '!Support') {
      message.author.send('https://discord.gg/28EKPz6 **رابط الدعم الفني ال بوت SVQ**').catch(e => console.log(e.stack));
 //SV-Q_LS
    }//SV-Q_LS
   }//SV-Q_LS
  });client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" Done | تــــم" , " |  تــــم ارســال الرابط الدعم الفني ال بوت SVQ في الخــاص")
     //SV-Q_LS
     //SV-Q_LS
//SV-Q_LS
  message.channel.sendEmbed(embed);
